...
var CmsModule$1 = /** @class */ (function () {
    ...
    CmsModule$$1.decorators = [
        { type: NgModule, args: [{
                    ...
                    providers: __spread(guards, [{ provide: CmsConfig, useExisting: Config }]),
                    declarations: [],
                    exports: [OutletDirective],
                },] }
    ];
...
var SearchBoxComponentService = /** @class */ (function () {
    function SearchBoxComponentService(componentData, searchService, routingService) {
        ...
        if (componentData) {
            this.config$ = merge(this.config$, this.componentData.data$.pipe(map(function (config) { return (__assign({}, _this.defaultConfig, config)); })));
        }
    }
    /**
     * @param {?} query
