(function (global, factory) {
    ...
    var CardModule = /** @class */ (function () {
        ...
        CardModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, i2.I18nModule],
    ...
    ***************************************************************************** */
                    ...
                    if (results === 'FAIL') {
                        ...
                        if (results.errors.errors.some(function (error) { return error.subject === 'titleCode'; })) {
                            _this.globalMessageService.add({
                                type: i2.GlobalMessageType.MSG_TYPE_ERROR,
    ...
    var DeliveryModeModule = /** @class */ (function () {
        ...
        DeliveryModeModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, forms.ReactiveFormsModule, i2.I18nModule],
    ...
    var ReviewSubmitModule = /** @class */ (function () {
        ...
        ReviewSubmitModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, CardModule, CartSharedModule, i2.I18nModule],
    ...
    var PwaModule = /** @class */ (function () {
        ...
        PwaModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [
                            common.CommonModule,
                            i2.ConfigModule.withConfig(defaultPWAModuleConfig),
                            serviceWorker.ServiceWorkerModule.register('/ngsw-worker.js'),
                            i2.I18nModule,
                        ],
                        providers: [
                            { provide: PWAModuleConfig, useExisting: i2.Config },
                            {
    ...
    var ProductTabsModule = /** @class */ (function () {
        ...
        ProductTabsModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        providers: [i2.ProductService, i2.WindowRef, i2.RoutingService],
                    },] }
        ];
    ...
    var AddressBookModule = /** @class */ (function () {
        ...
        AddressBookModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        providers: [i2.UserService, AddressBookComponentService],
                                        ...
                                        providers: [
                                            {
                                                ...
                                                deps: [CmsComponentData, i2.CmsConfig],
                                            },
                                        ],
                                    },
                                    BannerComponent: {
                                        ...
                                        providers: [
                                            {
                                                ...
                                                deps: [i2.CmsService, CmsComponentData],
                                            },
                                        ],
                                    },
                                },
                                        ...
                                        providers: [
                                            {
                                                ...
                                                deps: [CmsComponentData, i2.ProductService],
                                            },
                                        ],
                                    },
                                },
                                        ...
                                        providers: [
                                            {
                                                ...
                                                deps: [CmsComponentData, i2.ProductSearchService, i2.RoutingService],
                                            },
                                        ],
                                    },
                                },
    ...
    /** @type {?} */
    var LABELS = (_a = {},
        _a[i2.LANGUAGE_CONTEXT_ID] = 'Language',
        _a[i2.CURRENCY_CONTEXT_ID] = 'Currency',
        _a);
    var SiteContextComponentService = /** @class */ (function () {
        ...
        Object.defineProperty(SiteContextComponentService.prototype, "items$", {
             ...
             */ function () {
                var _this = this;
                return this.service$.pipe(operators.switchMap(function (service) { return service.getAll(); }), operators.switchMap(function (items) {
                    return _this.context$.pipe(operators.switchMap(function (context) {
        ...
        Object.defineProperty(SiteContextComponentService.prototype, "activeItem$", {
             ...
             * @return {?}
             */ function () {
                return this.service$.pipe(operators.switchMap(function (service) { return service.getActive(); }));
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(SiteContextComponentService.prototype, "label$", {
             ...
             * @return {?}
             */ function () {
                return this.componentData.data$.pipe(operators.map(function (data) {
        ...
        Object.defineProperty(SiteContextComponentService.prototype, "active", {
             ...
             * @return {?}
             */ function (value) {
                this.service$.pipe(operators.take(1)).subscribe(function (service) {
        ...
        Object.defineProperty(SiteContextComponentService.prototype, "service$", {
             ...
             */ function () {
                var _this = this;
                return this.context$.pipe(operators.map(function (context) { return _this.getService(context); }), operators.filter(Boolean));
            },
            enumerable: true,
            configurable: true
        });
         ...
         */
            function (item, context) {
                switch (context) {
                    case i2.LANGUAGE_CONTEXT_ID:
                        return item.nativeName;
                        break;
                    case i2.CURRENCY_CONTEXT_ID:
                                        ...
                                        providers: [
                                            {
                                                ...
                                                deps: [CmsComponentData, i2.ContextServiceMap, i0.Injector],
                                            },
                                        ],
                                    },
                                },
    ...
    var GlobalMessageComponent = /** @class */ (function () {
        function GlobalMessageComponent(globalMessageService) {
            this.globalMessageService = globalMessageService;
            this.messageType = i2.GlobalMessageType;
        }
        /**
         * @return {?}
         */
    ...
    var GlobalMessageComponentModule = /** @class */ (function () {
        ...
        GlobalMessageComponentModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, http.HttpClientModule, i2.GlobalMessageModule.forRoot()],
        ...
        OccModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        providers: [
                            ...
                            i2.OccMiscsService,
                            i2.OccOrderService,
                            { provide: i2.OccConfig, useExisting: i2.Config },
                        ],
                    },] }
        ];
        return OccModule;
    ...
    var ProductModule = /** @class */ (function () {
        ...
        ProductModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [common.CommonModule, i1.RouterModule, MediaModule, CmsModule],
                    },] }
        ];
    ...
    var ProductDetailsComponent = /** @class */ (function () {
        function ProductDetailsComponent(currentPageService) {
            this.currentPageService = currentPageService;
            this.openReview = new i0.EventEmitter();
        }
    ...
    var StoreFinderMapComponent = /** @class */ (function () {
        ...
        StoreFinderMapComponent.ctorParameters = function () {
            return [
                { type: i2.GoogleMapRendererService }
            ];
        };
            ...
            function () {
                ...
                this.subscription = this.auth
                    ...
                    if (data && data.access_token) {
                        _this.globalMessageService.remove(i2.GlobalMessageType.MSG_TYPE_ERROR);
         ...
         */
            function () {
                ...
                this.globalMessageService
                    ...
                    if (globalMessageEntities[i2.GlobalMessageType.MSG_TYPE_ERROR].some(function (message) { return message === 'This field is required.'; })) {
                        _this.globalMessageService.remove(i2.GlobalMessageType.MSG_TYPE_ERROR);
                        _this.globalMessageService.add({
                            type: i2.GlobalMessageType.MSG_TYPE_ERROR,
                            text: 'Title is required.',
        ...
        LayoutModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: __spread([
                            ...
                            i2.ConfigModule.withConfig(defaultLayoutConfig),
                        ]),
                        providers: [
                            { provide: LayoutConfig, useExisting: i2.Config },
                            BreakpointService,
                        ],
    ...
    var GuardsModule = /** @class */ (function () {
        ...
        GuardsModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [i2.RoutingModule, i2.CartModule],
    ...
    var routes$1 = [
        ...
        {
            path: null,
            canActivate: [i2.AuthGuard, CmsPageGuard, OrderConfirmationPageGuard],
    ...
    var ProductPageModule = /** @class */ (function () {
        ...
        ProductPageModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [
                            common.CommonModule,
                            i1.RouterModule.forChild(routes$2),
            ...
            { type: i0.NgModule, args: [{
                        imports: __spread([
                            ...
                            i1.RouterModule.forChild([
                                ...
                                {
                                    path: null,
                                    canActivate: [i2.AuthGuard, CmsPageGuard, CartNotEmptyGuard],
                                    component: PageLayoutComponent,
                                    data: ɵ4,
                                },
                                {
    ...
    function provideConfigFromMetaTags() {
        return [i2.provideConfigFactory(i2.serverConfigFromMetaTagFactory, [i1$1.Meta])];
    }
         ...
         */
            function (config) {
                return {
                    ...
                    providers: __spread([i2.provideConfig(config)], provideConfigFromMetaTags()),
                };
            };
        StorefrontModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [
                            ...
                            UiModule,
                            UiFrameworkModule,
                            i2.ConfigModule.forRoot(),
                            i2.CxApiModule,
                            i2.SmartEditModule.forRoot(),
                            MultiStepCheckoutModule,
                            i2.I18nModule.forRoot(),
                        ],
                        exports: [UiModule],
                        declarations: [],
                    },] }
